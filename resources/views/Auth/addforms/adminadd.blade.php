...
<div class=" w- mx-auto card card-primary  ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('store.institute')}}" method="post" enctype="multipart/form-data" class="px-5">
                @csrf
                <div class="card-body">
                <div class="row ">
                <div class="col-sm-6">
                  ...
                  <div class="form-group ">
                    ...
                    <input type="text" name="name" value="{{old('name')}}" class="form-control " id="exampleInputEmail1" placeholder="Enter School Name">
                  </div>
                  ...
                  <input type="password" class="form-control" id=password name="password" rows="3" placeholder="Enter ...">
                  </div>
                  <div class=" mt-n2 mb-3 fw-bold fs-6 text-danger">
                ...
                <div class="card-footer ">
                  <button type="submit" class="btn btn-primary w-25">Add School</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
