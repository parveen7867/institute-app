 ...
 <div class="content">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Add Accountants</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Accountants List</a></li>
...
<div class=" w- mx-auto card card-primary  ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{route('store.accountant')}}"  enctype="multipart/form-data" method="post" class="px-5">
                @csrf
                <div class="card-body">
                <div class="row ">
                <div class="col-sm-6">
                  ...
                  <div class="form-group ">
                    <label for="exampleInputEmail1">Accountant Name</label>
                    <input type="text" name="name" value="{{old('name')}}" class="form-control " id="exampleInputEmail1" placeholder="Enter Accountant Name">
                  </div>
                  ...
                  <div class="form-group ">
                    <label for="exampleInputPassword1">Accountant Email</label>
                  ...
                  <div class="col-sm-6">
                  <div class="form-group ">
                  <label for="formFile" class="form-label">Accountant picture</label>
                ...
                <div class="card-footer ">
                  <button type="submit" class="btn btn-primary w-25">Add Accountant</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
