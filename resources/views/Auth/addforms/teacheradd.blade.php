        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Teachers List</a></li>
...
<div class=" w- mx-auto card card-primary  ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{route('store.teacher')}}"  enctype="multipart/form-data" method="post" class="px-5">
                @csrf
                <div class="card-body">
                <div class="row ">
                <div class="col-sm-6">
                  ...
                  <div class="form-group ">
                    ...
                    <input type="text" name="name" value="{{old('name')}}" class="form-control " id="exampleInputEmail1" placeholder="Enter Teacher Name">
                  </div>
               ...
               <select name="course" class="form-select" id="category">
                 ...
                 <div class=" mt-n2 mb-3 fw-bold fs-6 text-danger">
                  ...
                  <div class="col-sm-6">
                  <div class="form-group ">
                  <label for="formFile" class="form-label">Teacher Picture</label>
                ...
                <div class="card-footer ">
                  <button type="submit" class="btn btn-primary w-25">Add Teacher</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
