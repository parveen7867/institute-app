...
<div class=" w- mx-auto card card-primary  ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('store.parent') }}" enctype="multipart/form-data" method="post" class="px-5">
                @csrf
                <div class="card-body">
                <div class="row ">
                <div class="col-sm-6">
                  ...
                  <div class="form-group ">
                    ...
                    <input type="text" name="name" value="{{old('name')}}" class="form-control " id="exampleInputEmail1" placeholder="Enter Parent Name">
                  </div>
                  ...
                  <div class="col-sm-6">
                  <div class="form-group ">
                  <label for="formFile" class="form-label">Parent logo</label>
                ...
                <div class="card-footer ">
                  <button type="submit" class="btn btn-primary w-25">Add Parent</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
