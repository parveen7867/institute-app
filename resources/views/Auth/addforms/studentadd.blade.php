...
@endif
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form  action="{{route('store.student')}}"  enctype="multipart/form-data" method="post" class="px-5">
                @csrf
                <div class="card-body">
                <div class="row ">
                <div class="col-sm-6">
                  ...
                  <div class="form-group ">
                    ...
                    <input type="text" name="name" value="{{old('name')}}" class="form-control " id="exampleInputEmail1" placeholder="Enter Student Name">
                  </div>
               ...
               <select name="course" class="form-select" id="category">
                 ...
                 <div class=" mt-n2 mb-3 fw-bold fs-6 text-danger">
                  ...
                  <input type="password" class="form-control" value="{{ old('password') }}" name="password" rows="3" placeholder="Enter ...">
                  </div>
                  <div class=" mt-n2 mb-3 fw-bold fs-6 text-danger">
                ...
                <div class="card-footer ">
                  <button type="submit" class="btn btn-primary w-25">Add Student</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
